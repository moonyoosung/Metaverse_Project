...
{
    public class WellnessViewContext : Context
    {
        private Sprite titleIcon;
        private Sprite backIcon;
        public WellnessViewContext(Sprite titleIcon, Sprite backIcon)
        {
            this.titleIcon = titleIcon;
            this.backIcon = backIcon;
        }
        private readonly Property<bool> _isActivePageDividerProperty = new Property<bool>();
        public bool IsActivePageDivider
        {
            get => _IsActiveDividerProperty.Value; set => _isActivePageDividerProperty.Value = value;
        }
